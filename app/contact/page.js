              ...
              return (
                <Card key={index} className="bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-gray-800 hover:border-[#1B9B8A] transition-all group">
                  <CardContent className="p-8 text-center">
                    ...
                    <h3 className="text-2xl font-bold mb-3 text-white" style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>{item.title}</h3>
            ...
            <Card className="bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800 border-2 border-[#D4AF37]/30">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-black mb-4 text-white" style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <Card className="bg-gradient-to-r from-[#D4AF37]/10 to-[#1B9B8A]/10 border-2 border-[#D4AF37]/30">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-2xl font-black mb-3 text-white" style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>
                BUSINESS HOURS
              </h3>
