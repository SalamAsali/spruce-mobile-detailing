              ...
              return (
                <Card key={index} className=\"bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-gray-800 hover:border-[#1B9B8A] transition-all group\">
                  <CardContent className=\"p-8 text-center\">
                    <div className=\"inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br ${item.color} mb-6 group-hover:scale-110 transition-transform\">
                      <Icon className=\"w-10 h-10 text-black\" />
                    </div>
                    <h3 className=\"text-2xl font-bold mb-3 text-white\" style={{ fontFamily: 'Montserrat, sans-serif' }}>{item.title}</h3>
            ...
            <Card className=\"bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800 border-2 border-[#D4AF37]/30\">
              <CardContent className=\"p-8\">
                <div className=\"text-center mb-8\">
                  <h2 className=\"text-3xl font-black mb-4 text-white\" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                ...
                <form className=\"space-y-6\">
                  <div className=\"grid md:grid-cols-2 gap-6\">
                    <div>
                      ...
                      <input
                        type=\"text\"
                        className=\"w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#1B9B8A] focus:outline-none transition-colors\"
                  ...
                  <div>
                    ...
                    <select className=\"w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#1B9B8A] focus:outline-none transition-colors\" required>
                  ...
                  <div>
                    ...
                    <select className=\"w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#1B9B8A] focus:outline-none transition-colors\">
                  ...
                  <div>
                    ...
                    <textarea
                      className=\"w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#1B9B8A] focus:outline-none transition-colors h-32\"
                      placeholder=\"Tell us about your vehicle and what services you're interested in...\"
                    ></textarea>
                  </div>

                  <Button size=\"lg\" className=\"w-full bg-gradient-to-r from-[#1B9B8A] to-[#158F7E] hover:from-[#158F7E] hover:to-[#1B9B8A] text-white py-6 text-lg font-bold\">
        ...
        <div className=\"container mx-auto max-w-6xl\">
          ...
          <div className=\"grid grid-cols-2 md:grid-cols-4 gap-4 mb-12\">
            {serviceAreas.map((area, index) => (
              <div
                key={index}
                className=\"flex items-center gap-3 px-4 py-3 bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-800 rounded-lg hover:border-[#1B9B8A] transition-all group\"
              >
          ...
          <Card className=\"bg-gradient-to-r from-[#D4AF37]/10 to-[#1B9B8A]/10 border-2 border-[#D4AF37]/30\">
            <CardContent className=\"p-8 text-center\">
              ...
              <h3 className=\"text-2xl font-black mb-3 text-white\" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                BUSINESS HOURS
              </h3>
