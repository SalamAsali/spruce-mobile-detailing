              ...
              return (
                <Card key={index} className="bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-gray-800 hover:border-[#D4AF37] transition-all group text-center">
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-2xl font-bold mb-3 text-white" style={{ fontFamily: 'Montserrat, sans-serif' }}>{cert.title}</h3>
            ...
            {values.map((value, index) => {
              ...
              return (
                <div key={index} className="text-center group">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-white" style={{ fontFamily: 'Montserrat, sans-serif' }}>{value.title}</h3>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-[#1B9B8A]/20 via-[#0A0A0A] to-[#D4AF37]/10 border-y-2 border-[#D4AF37]/20">
        <div className="container mx-auto max-w-6xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="border-2 border-[#D4AF37] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black px-12 py-7 text-lg font-bold" asChild>
