    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0A0A0A] via-[#0F1419] to-[#0A0A0A]">
      <section className="relative py-32 px-4 overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl text-center relative z-10">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black mb-6 text-white tracking-tight leading-[1.1]" style={{ fontFamily: 'var(--font-cinzel), Cinzel, serif', textWrap: 'balance' }}>SERVICE<br className="hidden sm:block" /> PACKAGES</h1>
      ...
      <section className="py-20 px-4 bg-[#0A0A0A] relative">
        ...
        <div className="container mx-auto max-w-7xl">
                ...
                <Card key={index} className={`bg-gradient-to-br from-gray-900 to-gray-800 border-2 ${pkg.color} transition-all group relative ${pkg.popular ? 'md:scale-105 shadow-2xl shadow-[#1B9B8A]/30' : ''}`}>
                  ...
                  <CardContent className={`p-8 ${pkg.popular ? 'pt-10' : ''}`}>
                    <div className="text-center mb-6">
                      ...
                      <h3 className="text-2xl font-black mb-2 text-white" style={{ fontFamily: 'var(--font-cinzel), Cinzel, serif', textWrap: 'balance' }}>{pkg.name}</h3>
          ...
          <div className="mt-16 bg-gradient-to-r from-[#D4AF37]/20 via-[#1B9B8A]/10 to-[#D4AF37]/20 border-2 border-[#D4AF37]/30 rounded-2xl p-8 text-center">
            <h3 className="text-2xl font-black text-white mb-4" style={{ fontFamily: 'var(--font-cinzel), Cinzel, serif', textWrap: 'balance' }}>CUSTOM PACKAGES AVAILABLE</h3>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-[#1B9B8A]/20 via-[#0A0A0A] to-[#D4AF37]/10 border-y-2 border-[#1B9B8A]/20">
        <div className="container mx-auto max-w-6xl text-center">
          <h2 className="text-2xl sm:text-3xl md:text-2xl sm:text-3xl md:text-4xl font-black mb-4 md:mb-6 text-white" style={{ fontFamily: 'var(--font-cinzel), Cinzel, serif', textWrap: 'balance' }}>READY TO GET STARTED?</h2>
