    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0A0A0A] via-[#0F1419] to-[#0A0A0A]">
      <section className="relative py-32 px-4 overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl text-center relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black mb-6 text-white tracking-tight leading-[1.1]" style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>THE SPRUCE<br className="hidden sm:block" /> SHIELD CLUB</h1>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-[#D4AF37]/20 via-[#0A0A0A] to-[#1B9B8A]/10 border-y-2 border-[#D4AF37]/20">
        <div className="container mx-auto max-w-6xl text-center">
          <h2 className="text-2xl sm:text-3xl md:text-2xl sm:text-3xl md:text-4xl font-black mb-4 md:mb-6 text-white" style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>JOIN THE SPRUCE<br className="hidden sm:block" /> SHIELD CLUB TODAY</h2>
