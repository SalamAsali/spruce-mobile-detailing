      ...
      <section className="py-20 px-4 bg-[#0A0A0A] relative">
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black mb-6 text-white" style={{ fontFamily: 'Montserrat, sans-serif' }}>MEMBERSHIP BENEFITS</h2>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-[#0F1419] to-[#0A0A0A]">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black mb-6 text-white" style={{ fontFamily: 'Montserrat, sans-serif' }}>HOW TO JOIN</h2>
