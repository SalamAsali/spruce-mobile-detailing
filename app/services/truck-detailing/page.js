    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0A0A0A] via-[#0F1419] to-[#0A0A0A]">
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="mt-12 bg-gradient-to-r from-[#D4AF37]/20 via-[#1B9B8A]/10 to-[#D4AF37]/20 border-2 border-[#D4AF37]/30 rounded-2xl p-8 text-center">
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <h3 className="text-2xl font-black text-white" style={{ fontFamily: 'var(--font-cinzel), Cinzel, serif', textWrap: 'balance' }}>TRUCK RESTORATION SERVICES</h3>
              <Star className="w-6 h-6 text-[#D4AF37] fill-[#D4AF37]" />
            </div>
      ...
      <section className="py-20 px-4 bg-[#0A0A0A]">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-4xl font-black text-center mb-16 text-white" style={{ fontFamily: 'var(--font-cinzel), Cinzel, serif', textWrap: 'balance' }}>
            HOW IT WORKS
          </h2>
