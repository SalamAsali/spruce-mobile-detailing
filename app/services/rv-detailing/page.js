        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="mt-12 bg-gradient-to-r from-[#D4AF37]/20 via-[#1B9B8A]/10 to-[#D4AF37]/20 border-2 border-[#D4AF37]/30 rounded-2xl p-8 text-center">
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <h3 className="text-2xl font-black text-white" style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>RV RESTORATION SPECIALIST</h3>
              <Star className="w-6 h-6 text-[#D4AF37] fill-[#D4AF37]" />
            </div>
      ...
      <section id="pricing" className="py-20 px-4 bg-gradient-to-b from-[#0F1419] to-[#0A0A0A]">
        <div className="container mx-auto max-w-7xl">
            ...
            {pricingTiers.map((tier, index) => (
              <Card key={index} className={`bg-gradient-to-br ${tier.color} border-2 ${tier.border} overflow-hidden relative group hover:scale-105 transition-all duration-300 ${tier.popular ? 'md:scale-110 shadow-2xl shadow-[#1B9B8A]/50' : ''}`}>
                ...
                <CardContent className={`p-8 ${tier.popular ? 'pt-14' : ''}`}>
                  <h3 className={`text-2xl font-black mb-2 ${tier.name === 'Ultimate Restoration' ? 'text-black' : 'text-white'}`} style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>
                    {tier.name}
                  </h3>
                  <div className="mb-4">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-gray-800 rounded-2xl p-8">
            <h3 className="text-2xl font-black text-center mb-8 text-white" style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>
              PACKAGE COMPARISON
            </h3>
          ...
          <div className="mt-12 bg-gradient-to-r from-[#1B9B8A]/20 via-[#D4AF37]/10 to-[#1B9B8A]/20 border-2 border-[#D4AF37]/30 rounded-2xl p-8 text-center">
            <h3 className="text-2xl font-black text-white mb-4" style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>
          ...
          <div className="mt-16">
            <div className="text-center mb-12">
              <h3 className="text-3xl md:text-4xl font-black mb-4 text-white" style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>
                    ...
                    <CardContent className={`p-8 ${addon.featured ? 'pt-12' : ''}`}>
                      <div className="flex items-start gap-4 mb-6">
                        ...
                        <div className="flex-1">
                          <h4 className="text-2xl font-black mb-2 text-white" style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>{addon.name}</h4>
