...
import { Phone, MapPin, CheckCircle, Star, Car, Truck, Bike, Ship } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0A0A0A] via-[#0F1419] to-[#0A0A0A]">
      <section className="relative py-24 px-4 pt-44 md:pt-48 lg:pt-40 xl:pt-44 overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1619734086067-24bf8889ea7d?w=1920&q=80)', backgroundPosition: 'center' }}>
        ...
        <div className="container mx-auto max-w-6xl text-center relative z-10">
          <div className="inline-block mb-4">
            <div className="flex items-center gap-2 bg-[#1B9B8A]/10 border-2 border-[#1B9B8A]/40 rounded-full px-6 py-2">
              ...
              <span className="text-[#1B9B8A] text-sm font-semibold tracking-wider">DENVER MOBILE DETAILING</span>
            </div>
          </div>
          ...
          <h1 className="text-5xl md:text-7xl font-black mb-6 text-white tracking-tight leading-[1.1]" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            PROFESSIONAL DETAILING<br className="hidden sm:block" /> IN DENVER
          </h1>
          <p className="text-gray-300 text-xl md:text-2xl mb-8 max-w-4xl mx-auto leading-relaxed">
            Premium mobile auto detailing services<br className="hidden sm:block" /> serving Denver and surrounding areas.
          </p>
          <Button size="lg" className="bg-gradient-to-r from-[#1B9B8A] to-[#158F7E] hover:from-[#158F7E] hover:to-[#1B9B8A] text-white px-10 py-7 text-lg font-bold shadow-2xl" asChild>
      ...
      <section className="py-20 px-4 bg-[#0A0A0A]">
        <div className="container mx-auto max-w-7xl">
          <h2 className="text-4xl font-black text-center mb-12 text-white" style={{ fontFamily: 'Montserrat, sans-serif' }}>SERVICES IN DENVER</h2>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-[#1B9B8A]/20 via-[#0A0A0A] to-[#D4AF37]/10 border-y border-[#D4AF37]/20">
        <div className="container mx-auto max-w-6xl text-center">
          <h2 className="text-4xl md:text-5xl font-black mb-6 text-white" style={{ fontFamily: 'Montserrat, sans-serif' }}>READY FOR DENVER'S<br className="hidden sm:block" /> BEST MOBILE DETAILING?</h2>
          <p className="text-gray-300 text-xl mb-10 max-w-3xl mx-auto">Call us today for a free quote and experience premium service.</p>
