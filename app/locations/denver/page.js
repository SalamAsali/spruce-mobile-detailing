      ...
      <section className="relative py-24 px-4 pt-44 md:pt-48 lg:pt-40 xl:pt-44 overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl text-center relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black mb-4 md:mb-6 text-white tracking-tight leading-[1.1]" style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>
            DETAILING SERVICES IN Denver
          </h1>
          <p className="text-gray-300 text-lg md:text-xl mb-8 max-w-4xl mx-auto leading-relaxed px-4">
            Premium mobile auto detailing serving Denver and surrounding areas. We come to you.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-2xl sm:text-3xl md:text-4xl font-black mb-4 md:mb-6 text-white" style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>
                WHY CHOOSE SPRUCE IN Denver?
              </h2>
              <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                We bring professional-grade detailing, restoration, and ceramic coating services directly to your location in Denver. Our certified team uses System X, Glidecoat, and Suntek products to protect your investment.
              </p>
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden">
              <img src="https://images.unsplash.com/photo-1607860108855-64acf2078ed9?w=800&q=80" alt={`Detailing in $Denver`} className="w-full h-full object-cover" />
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="bg-gradient-to-r from-[#D4AF37]/20 via-[#1B9B8A]/10 to-[#D4AF37]/20 border-2 border-[#D4AF37]/30 rounded-2xl p-8 text-center">
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <h3 className="text-2xl font-black text-white" style={{ fontFamily: 'Montserrat, sans-serif', textWrap: 'balance' }}>SERVING Denver & SURROUNDING AREAS</h3>
              <Star className="w-6 h-6 text-[#D4AF37] fill-[#D4AF37]" />
            </div>
